...
pdf.cell(0, 7, 'Estudiante: [Nombre del Estudiante]', align='C')
pdf.ln(7)
pdf.cell(0, 7, 'Universidad [Nombre de la Universidad]', align='C')
pdf.ln(7)
pdf.cell(0, 7, 'Facultad de [Facultad]', align='C')
